...
const huskyWeight = breeds[breeds.findIndex(dog => dog.breed === 'Husky')].averageWeight
const dogBothActivities = breeds.find(dog => dog.activities.includes('running', 'fetch'))
